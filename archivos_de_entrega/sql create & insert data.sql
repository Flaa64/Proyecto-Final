...
foreign key(id)
references genero_titulo(idTitulo),
constraint fk_reparto
foreign key(id)
references reparto(idTitulo)
) engine=innodb;
insert into categorias(id,categoria) values(1,"Película"); 
insert into categorias(id,categoria) values(2,"Serie"); 
insert into actores(id,actor) values(1,"Pedro Pascal"); 
insert into actores(id,actor) values(2,"Carl Weathers"); 
insert into actores(id,actor) values(3,"Misty Rosas"); 
insert into actores(id,actor) values(4,"Chris Bartlett"); 
insert into actores(id,actor) values(5,"Rio Hackford"); 
insert into actores(id,actor) values(6,"Giancarlo Esposito"); 
insert into actores(id,actor) values(7,"Tom Hopper"); 
insert into actores(id,actor) values(8,"David Castañeda"); 
insert into actores(id,actor) values(9,"Emmy Raver-Lampman"); 
insert into actores(id,actor) values(10,"Robert Sheehan"); 
insert into actores(id,actor) values(11,"Aidan Gallagher"); 
insert into actores(id,actor) values(12,"Elliot Page"); 
insert into actores(id,actor) values(13,"Anya Taylor-Joy"); 
insert into actores(id,actor) values(14,"Thomas Brodie-Sangster"); 
insert into actores(id,actor) values(15,"Harry Melling"); 
insert into actores(id,actor) values(16,"Moses Ingram"); 
insert into actores(id,actor) values(17,"Chloe Pirrie"); 
insert into actores(id,actor) values(18,"Janina Elkin"); 
insert into actores(id,actor) values(19,"Lili Reinhart"); 
insert into actores(id,actor) values(20,"Casey Cott"); 
insert into actores(id,actor) values(21,"Camila Mendes"); 
insert into actores(id,actor) values(22,"Marisol Nichols"); 
insert into actores(id,actor) values(23,"Madelaine Petsch"); 
insert into actores(id,actor) values(24,"Mädchen Amick"); 
insert into actores(id,actor) values(25,"Claire Fox"); 
insert into actores(id,actor) values(26,"Olivia Colman"); 
insert into actores(id,actor) values(27,"Matt Smith"); 
insert into actores(id,actor) values(28,"Tobias Menzies"); 
insert into actores(id,actor) values(29,"Vanesa Kirby"); 
insert into actores(id,actor) values(30,"Helena Bonham Carter"); 
insert into actores(id,actor) values(31,"Millie Bobby Brown"); 
insert into actores(id,actor) values(32,"Henry Cavill"); 
insert into actores(id,actor) values(33,"Sam Claflin"); 
insert into actores(id,actor) values(34,"Louis Partridge"); 
insert into actores(id,actor) values(35,"Adeel Akhtar"); 
insert into actores(id,actor) values(36,"Joaquin Phoenix"); 
insert into actores(id,actor) values(37,"Robert De Niro"); 
insert into actores(id,actor) values(38,"Zazie Beetz"); 
insert into actores(id,actor) values(39,"Frances Conroy"); 
insert into actores(id,actor) values(40,"Brett Cullen"); 
insert into actores(id,actor) values(41,"Shea Whigham"); 
insert into actores(id,actor) values(42,"Robert Downey Jr."); 
insert into actores(id,actor) values(43,"Chris Evans"); 
insert into actores(id,actor) values(44,"Mark Ruffalo"); 
insert into actores(id,actor) values(45,"Chris Hemsworth"); 
insert into actores(id,actor) values(46,"Scarlett Johansson"); 
insert into actores(id,actor) values(47,"Jeremy Renner"); 
insert into actores(id,actor) values(48,"Emilia Clarke"); 
insert into actores(id,actor) values(49,"Lena Headey"); 
insert into actores(id,actor) values(50,"Sophie Turner"); 
insert into actores(id,actor) values(51,"Kit Harington"); 
insert into actores(id,actor) values(52,"Peter Dinklage"); 
insert into actores(id,actor) values(53,"Nikolaj Coster-Waldau"); 
insert into actores(id,actor) values(54,"Grant Gustin"); 
insert into actores(id,actor) values(55,"Carlos Valdes"); 
insert into actores(id,actor) values(56,"Danielle Panabaker"); 
insert into actores(id,actor) values(57,"Candice Patton"); 
insert into actores(id,actor) values(58,"Jesse L. Martin"); 
insert into actores(id,actor) values(59,"Tom Cavanagh"); 
insert into actores(id,actor) values(60,"Jim Parsons"); 
insert into actores(id,actor) values(61,"Johnny Galecki"); 
insert into actores(id,actor) values(62,"Kaley Cuoco"); 
insert into actores(id,actor) values(63,"Simon Helberg"); 
insert into actores(id,actor) values(64,"Kunal Nayyar"); 
insert into actores(id,actor) values(65,"Melissa Rauch"); 
insert into actores(id,actor) values(66,"Mayim Bialik"); 
insert into actores(id,actor) values(67,"Jennifer Aniston"); 
insert into actores(id,actor) values(68,"Courteney Cox"); 
insert into actores(id,actor) values(69,"Lisa Kudrow"); 
insert into actores(id,actor) values(70,"David Schwimmer"); 
insert into actores(id,actor) values(71,"Matthew Perry"); 
insert into actores(id,actor) values(72,"Matt LeBlanc"); 
insert into actores(id,actor) values(73,"Amybeth McNulty"); 
insert into actores(id,actor) values(74,"Geraldine James"); 
insert into actores(id,actor) values(75,"R. H. Thomson"); 
insert into actores(id,actor) values(76,"Corrine Koslo"); 
insert into actores(id,actor) values(77,"Dalila Bela"); 
insert into actores(id,actor) values(78,"Lucas Jade Zumann"); 
insert into actores(id,actor) values(79,"Gillian Anderson"); 
insert into actores(id,actor) values(80,"David Duchovny"); 
insert into actores(id,actor) values(81,"Mitch Pileggi"); 
insert into actores(id,actor) values(82,"Robert Patrick"); 
insert into actores(id,actor) values(83,"Tom Braidwood"); 
insert into actores(id,actor) values(84,"Bruce Harwood"); 
insert into actores(id,actor) values(85,"Jared Harris"); 
insert into actores(id,actor) values(86,"Stellan Skarsgård"); 
insert into actores(id,actor) values(87,"Emily Watson"); 
insert into actores(id,actor) values(88,"Paul Ritter"); 
insert into actores(id,actor) values(89,"Jessie Buckley"); 
insert into actores(id,actor) values(90,"Adam Nagaitis"); 
insert into actores(id,actor) values(91,"Evan Rachel Wood"); 
insert into actores(id,actor) values(92,"Thandie Newton"); 
insert into actores(id,actor) values(93,"Jeffrey Wright"); 
insert into actores(id,actor) values(94,"Tessa Thompson"); 
insert into actores(id,actor) values(95,"Ed Harris"); 
insert into actores(id,actor) values(96,"Luke Hemsworth"); 
insert into actores(id,actor) values(97,"Lee Pace"); 
insert into actores(id,actor) values(98,"Scoot McNairy"); 
insert into actores(id,actor) values(99,"Mackenzie Davis"); 
insert into actores(id,actor) values(100,"Kerry Bishé"); 
insert into actores(id,actor) values(101,"Toby Huss"); 
insert into actores(id,actor) values(102,"Alana Cavanaugh"); 
insert into actores(id,actor) values(103,"Jessica Chastain"); 
insert into actores(id,actor) values(104,"John Malkovich"); 
insert into actores(id,actor) values(105,"Colin Farrell"); 
insert into actores(id,actor) values(106,"Common"); 
insert into actores(id,actor) values(107,"Geena Davis"); 
insert into actores(id,actor) values(108,"Ioan Gruffudd"); 
insert into actores(id,actor) values(109,"Margot Robbie"); 
insert into actores(id,actor) values(110,"Ewan McGregor"); 
insert into actores(id,actor) values(111,"Mary Elizabeth Winstead"); 
insert into actores(id,actor) values(112,"Jurnee Smollett"); 
insert into actores(id,actor) values(113,"Rosie Perez"); 
insert into actores(id,actor) values(114,"Chris Messina"); 
insert into actores(id,actor) values(115,"Stacy Martin"); 
insert into actores(id,actor) values(116,"Rhona Mitra"); 
insert into actores(id,actor) values(117,"Theo James"); 
insert into actores(id,actor) values(118,"Peter Ferdinando"); 
insert into actores(id,actor) values(119,"Lia Williams"); 
insert into actores(id,actor) values(120,"Toby Jones"); 
insert into actores(id,actor) values(121,"Dwayne Johnson"); 
insert into actores(id,actor) values(122,"Kevin Hart"); 
insert into actores(id,actor) values(123,"Jack Black"); 
insert into actores(id,actor) values(124,"Karen Gillan"); 
insert into actores(id,actor) values(125,"Awkwafina"); 
insert into actores(id,actor) values(126,"Nick Jonas"); 
insert into actores(id,actor) values(127,"Miranda Cosgrove"); 
insert into actores(id,actor) values(128,"Kate Walsh"); 
insert into actores(id,actor) values(129,"Omar Epps"); 
insert into actores(id,actor) values(130,"Angus Macfadyen"); 
insert into actores(id,actor) values(131,"Jorja Fox"); 
insert into actores(id,actor) values(132,"Enver Gjokaj"); 
insert into actores(id,actor) values(133,"Bill Skarsgård"); 
insert into actores(id,actor) values(134,"Bill Hader"); 
insert into actores(id,actor) values(135,"James McAvoy"); 
insert into actores(id,actor) values(136,"Isaiah Mustafa"); 
insert into actores(id,actor) values(137,"Jay Ryan"); 
insert into actores(id,actor) values(138,"Chadwick Boseman"); 
insert into actores(id,actor) values(139,"Michael B. Jordan"); 
insert into actores(id,actor) values(140,"Lupita Nyong'o"); 
insert into actores(id,actor) values(141,"Danai Gurira"); 
insert into actores(id,actor) values(142,"Martin Freeman"); 
insert into actores(id,actor) values(143,"Daniel Kaluuya"); 
insert into actores(id,actor) values(144,"Christian Bale"); 
insert into actores(id,actor) values(145,"Matt Damon"); 
insert into actores(id,actor) values(146,"Caitriona Balfe"); 
insert into actores(id,actor) values(147,"Josh Lucas"); 
insert into actores(id,actor) values(148,"Noah Jupe"); 
insert into actores(id,actor) values(149,"Jon Bernthal"); 
insert into actores(id,actor) values(150,"Génesis Rodríguez"); 
insert into actores(id,actor) values(151,"Vincent Piazza"); 
insert into actores(id,actor) values(152,"Benjamin Sokolow"); 
insert into actores(id,actor) values(153,"Emily Bayiokos"); 
insert into actores(id,actor) values(154,"Amy Manson"); 
insert into actores(id,actor) values(155,"Luke Allen-Gale"); 
insert into actores(id,actor) values(156,"Nina Bergman"); 
insert into actores(id,actor) values(157,"Dominic Mafham"); 
insert into actores(id,actor) values(158,"James Weber Brown"); 
insert into actores(id,actor) values(159,"Lorina Kamburova"); 
insert into actores(id,actor) values(160,"Marion Cotillard"); 
insert into actores(id,actor) values(161,"Laurence Fishburne"); 
insert into actores(id,actor) values(162,"Jude Law"); 
insert into actores(id,actor) values(163,"Kate Winslet"); 
insert into actores(id,actor) values(164,"Jennifer Ehle"); 
insert into actores(id,actor) values(165,"Gwyneth Paltrow"); 
insert into actores(id,actor) values(166,"Florence Pugh"); 
insert into actores(id,actor) values(167,"David Harbour"); 
insert into actores(id,actor) values(168,"O.T. Fagbenle"); 
insert into actores(id,actor) values(169,"Rachel Weisz"); 
insert into actores(id,actor) values(170,"William Hurt"); 
insert into actores(id,actor) values(171,"Ray Winstone"); 
insert into actores(id,actor) values(172,"Kristen Wiig"); 
insert into actores(id,actor) values(173,"Jeff Daniels"); 
insert into actores(id,actor) values(174,"Michael Peña"); 
insert into actores(id,actor) values(175,"Sean Bean"); 
insert into actores(id,actor) values(176,"Kate Mara"); 
insert into actores(id,actor) values(177,"Alicia Vikander"); 
insert into actores(id,actor) values(178,"Domhnall Gleeson"); 
insert into actores(id,actor) values(179,"Oscar Isaac"); 
insert into actores(id,actor) values(180,"Sonoya Mizuno"); 
insert into actores(id,actor) values(181,"Corey Johnson"); 
insert into actores(id,actor) values(182,"Claire Selby"); 
insert into actores(id,actor) values(183,"Gana Bayarsaikhan"); 
insert into actores(id,actor) values(184,"Bryce Dallas Howard"); 
insert into actores(id,actor) values(185,"Chris Pratt"); 
insert into actores(id,actor) values(186,"Irrfan Khan"); 
insert into actores(id,actor) values(187,"Vincent D'Onofrio"); 
insert into actores(id,actor) values(188,"Omar Sy"); 
insert into actores(id,actor) values(189,"Nick Robinson"); 
insert into actores(id,actor) values(190,"Judy Greer"); 
insert into actores(id,actor) values(191,"Will Smith"); 
insert into actores(id,actor) values(192,"Alice Braga"); 
insert into actores(id,actor) values(193,"Charlie Tahan"); 
insert into actores(id,actor) values(194,"Dash Mihok"); 
insert into actores(id,actor) values(195,"Salli Richardson-Whitfield"); 
insert into actores(id,actor) values(196,"Willow Smith"); 
insert into actores(id,actor) values(197,"Emma Thompson"); 
insert into actores(id,actor) values(198,"Ryan Gosling"); 
insert into actores(id,actor) values(199,"Claire Foy"); 
insert into actores(id,actor) values(200,"Jason Clarke"); 
insert into actores(id,actor) values(201,"Kyle Chandler"); 
insert into actores(id,actor) values(202,"Corey Stoll"); 
insert into actores(id,actor) values(203,"Patrick Fugit"); 
insert into actores(id,actor) values(204,"John Boyega"); 
insert into actores(id,actor) values(205,"Scott Eastwood"); 
insert into actores(id,actor) values(206,"Cailee Spaeny"); 
insert into actores(id,actor) values(207,"Jing Tian"); 
insert into actores(id,actor) values(208,"Rinko Kikuchi"); 
insert into actores(id,actor) values(209,"Burn Gorman"); 
...
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(3,"/posters/3.jpg","The Mandalorian",2,"Ambientada tras la caída del Imperio y antes de la aparición de la Primera Orden, la serie sigue los pasos de un pistolero solitario en las aventuras que protagoniza en los confines de la galaxia, donde no alcanza la autoridad de la Nueva República.",2,"https://www.youtube.com/embed/aOC8E8z_ifw"); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(4,"/posters/4.jpg","The Umbrella Academy",2,"La muerte de su padre reúne a unos hermanos distanciados y con extraordinarios poderes que descubren impactantes secretos y una amenaza que se cierne sobre la humanidad.",1,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(5,"/posters/5.jpg","Gambito de Dama",2,"En los cincuenta, una joven de un orfanato descubre que tiene un increíble don para el ajedrez y recorre el arduo camino a la fama mientras lucha contra las adicciones.",1,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(2,"/posters/2.jpg","Riverdale",2,"El paso a la edad adulta incluye sexo, romance, escuela y familia. Para Archie y sus amigos, también hay misterios oscuros.",5,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(1,"/posters/1.jpg","The Crown",2,"Este drama narra las rivalidades políticas y el romance de la reina Isabel II, así como los sucesos que moldearon la segunda mitad del siglo XX.",4,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(6,"/posters/6.jpg","Enola Holmes",1,"La hermana menor de Sherlock, descubre que su madre ha desaparecido y se dispone a encontrarla. En su búsqueda, saca a relucir el sabueso que corre por sus venas y se encuentra con una conspiración que gira en torno a un misterioso lord, demostrando que su ilustre hermano no es el único talento en la familia.",0,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(7,"/posters/7.jpg","Guasón",1,"Arthur Fleck (Phoenix) es un hombre ignorado por la sociedad, cuya motivación en la vida es hacer reír. Pero una serie de trágicos acontecimientos le llevarán a ver el mundo de otra forma. Película basada en el popular personaje de DC Comics Joker, conocido como archivillano de Batman, pero que en este film tomará un cariz más realista y oscuro.",0,"https://www.youtube.com/embed/zAGVQLHvwOY"); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(8,"/posters/8.jpg","Avengers: End Game",1,"Después de los devastadores eventos de los Vengadores: Infinity War (2018), el universo está en ruinas. Con la ayuda de los aliados restantes, los Vengadores se reúnen una vez más para revertir las acciones de Thanos y restaurar el equilibrio del universo.",0,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(9,"/posters/9.jpg","Juego de tronos",2,"En un mundo fantástico y en un contexto medieval varias familias, relativas a la nobleza, se disputan el poder para dominar el territorio ficticio de Poniente (Westeros) y tomar el control de los Siete Reinos desde el Trono de Hierro, lugar donde el rey ejerce el poder.",8,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(10,"/posters/10.jpg","The Flash",2,"Sigue las veloces aventuras de Barry Allen, un joven común y corriente con el deseo latente de ayudar a los demás. Cuando una inesperada partícula aceleradora golpea por accidente a Barry, de pronto se encuentra cargado de un increíble poder para moverse a increíbles velocidades. Mientras Barry siempre ha tenido el alma de un héroe, sus nuevos poderes le han dado la capacidad de actuar como tal.",6,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(11,"/posters/11.jpg","The Big Bang Theory",2,"Leonard y Sheldon son dos físicos que comparten trabajo y apartamento. La serie comienza con la mudanza de Penny, su nueva y atractiva vecina, y hace hincapié en la dificultad de los físicos para relacionarse con personas fuera de su entorno para dar lugar a situaciones cómicas.",12,"https://www.youtube.com/embed/WBb3fojgW0Q"); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(12,"/posters/12.jpg","Friends",2,"'Friends' narra las aventuras y desventuras de seis jóvenes de Nueva York: Rachel, Monica, Phoebe, Ross, Chandler y Joey. Ellos forman una unida pandilla de amigos que viven en Manhattan y que suelen reunirse en sus apartamentos o en su bar habitual cafetería, el Central Perk. A pesar de los numerosos cambios que se producen en sus vidas, su amistad es inquebrantable en la dura batalla por salir adelante en sus periplos profesionales y personales.",10,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(13,"/posters/13.jpg","Anne with an 'E'",2,"Anne Shirley es una niña huérfana que vive en un pequeño pueblo llamado Avonlea que pertenece a la Isla del Príncipe Eduardo, en el año 1890. Después de una infancia difícil, donde fue pasando de orfanato a hogares de acogida, es enviada por error a vivir con una solterona y su hermano. Cuando cumple 13 años, Anne va a conseguir transformar su vida y el pequeño pueblo donde vive gracias a su fuerte personalidad, intelecto e imaginación. Basada en la inolvidable novela.",2,""); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(14,"/posters/14.jpg","Expedientes Secretos 'X'",2,"Fox Mulder y Dana Scully son dos investigadores del FBI que investigan casos sin resolución ni explicación, ya sea por razones paranormales (espíritus, criaturas extrañas, aliens...) ya porque el gobierno se ha encargado de ocultar todo tipo de pruebas. Cuando Mulder tenía doce años, su hermana pequeña fue secuestrada por unos desconocidos, aunque él cree que, en realidad, fue abducida por extraterrestres. Tras acabar sus estudios en la universidad de Oxford, ingresó en la Academia de Quantico, donde se ganó el apodo de 'siniestro'",11,"https://www.youtube.com/embed/KKziOmsJxzE"); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(15,"/posters/15.jpg","Chernobyl",2,"Sigue «la verdadera historia de una de las peores catástrofes provocadas por el hombre y habla de los valientes hombres y mujeres que se sacrificaron para salvar a Europa de un desastre inimaginable. La miniserie se centra en el desgarrador alcance del desastre de la planta nuclear que ocurrió en Ucrania en abril de 1986, revelando cómo y por qué ocurrió, además contando las sorprendentes y notables historias de los héroes que lucharon y cayeron.",1,"https://www.youtube.com/embed/s9APLXM9Ei8"); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(16,"/posters/16.jpg","Westworld",2,"'Westworld' es una oscura odisea acerca del amanecer de la conciencia artificial y la evolución del pecado. Situada en la intersección del futuro cercano y el pasado reimaginado, explora un mundo donde cada apetito humano, sin importar cuán noble o depravado, puede ser saciado. Está ambientada en un parque temático futurista dirigido por el Dr. Robert Ford (Anthony Hopkins). Las instalaciones cuentan con androides caracterizados del western americano, y gracias a ellos los visitantes pueden introducirse en cualquier tipo de fantasía por muy oscura que sea.",3,"https://www.youtube.com/embed/qLFBcdd6Qw0"); 
insert into titulos(id,poster,titulo,categoria,resumen,temporadas,trailer) values(17,"/posters/17.jpg","Halt and Catch Fire",2,"Situada en los inicios de la década de 1980, un visionario ficticio, un ingeniero electrónico y una prodigiosa ingeniera, se alían a una programadora de software para confrontar con las corporaciones informáticas dominantes de la época. El Personal de la firma y sus socios de negocio, comenzarán una carrera que cambiará la cultura en el Estado de Texas, cuna de las empresas de tecnología, casi de la misma forma que lo es hoy Silicon Valey. 
